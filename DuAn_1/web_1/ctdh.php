        ...
        <div class="pizzaex">
            ...
            <div id="myModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    echo 'MMời bạn đăng nhập để thêm sản phẩm vào giỏ hàng của mình!';
                }
                ?>
...
<h1> Chào <?php echo $_SESSION['tentk'] ?></h1>
   <div class="giohang">
        ...
        <tr class="cha">
            ...
            <td style="width: 450px;">Sản phẩm</td>
            <td style="width: 200px;">Giá</td>
            <td style="width: 100px;">Số lượng</td>
            <td style="width: 180px;">Tổng</td>
        </tr>
                        ...
                        <td class="giasp">
                            <?php
                                if($dh['id_dm']==1){
                                    ...
                                    echo " : ".number_format($dh['gia_tien'],0,',','.'); echo 'đ';
                                    ?>
                                        <input type="hidden" class="gia" value="<?php echo $dh['gia_tien']?>">
                                    <?php
                                }else{
                                    echo number_format($dh['giasp'],0,',','.');  echo 'đ';
                                    ?>
