...
<body>
    <section>
        ...
        <div class="table">
            ...
            <button class="ctdh"><a href="quanlydht.php">Đơn hàng Vãn Lai</a></button>
                    ...
                    foreach($kq as $key => $value){
                        ?>
                         <tr>
                            ...
                            ?></td>
                            <td><button><a href="chitietdh.php?iddh=<?php echo $value['id_dh']?>">Chi tiết đơn hàng</a></button></td>
                        </tr>
                        <tr>
                            <td colspan="8"><hr></td>
                        </tr>
