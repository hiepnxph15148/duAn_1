...
<body>
    <section>
        ...
        <div class="table">
                    ...
                    foreach($kq as $key => $value){
                        ?>
                         <tr>
                            ...
                            <td><button><a href="fixtk.php?ma=<?php echo $value['id_tk'] ?>">Sửa</a></button></td>
                        </tr>
                        <tr>
            ...
            <button class="add"><a href="addtk.php">Thêm tài khoản</a></button>
                </div>
    </section>
