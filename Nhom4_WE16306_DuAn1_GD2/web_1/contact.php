...
<body>
    <div class="main">
        <header>
            <div class="pizzaex">
                <img style="width: 12%;" src="./../assets/img/footer_logo1.png" alt="">
            ...
            <div class="grid">
                <div class="">
                    ...
                    <div class="breadcrumbs">
                        <span>
                            <span>
                                <a href="#">Trang chủ</a> / <a href="./contact.html">Liên hệ</a>
                            </span>
                        </span>
                    </div>
                </div>
            ...
            <div class="grid">
                <div class="container">
                    <div class="container__sidebar">
                        <h3 class="container__sidebar-title">CÔNG TY TNHH PIZZA CAPICHI VIỆT NAM</h3>
                        ...
                        <h3 class="container__sidebar-title">CÁC CƠ SỞ PIZZA Capichi</h3>
                        <div class="result__wrap">
                            <main class="result__item result__item-active">
                                <div class="result__item-thumb">
                                    <img src="./../assets/img/so_01.png" alt="">
                                </div>

                                <div class="result__item-infor">
                                    <h3>Pizza Capichi Ngọc Khánh</h3>
                            ...
                            <main class="result__item">
                                <div class="result__item-thumb">
                                    <img src="./../assets/img/so_02.png" alt="">
                                </div>

                                <div class="result__item-infor">
                                    <h3>Pizza Capichi Nguyễn Trãi</h3>
