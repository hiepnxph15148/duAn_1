...
<body>
        ...
        <div class="pizzaex">
            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    echo 'Mời bạn đăng nhập để thêm sản phẩm vào giỏ hàng!';
                }
                ?>
    ...
    <div class="td_thucdon">
        <img src="picture/line_title.png" alt="">
        <p>Thực Đơn</p>
        <img src="picture/line_title.png" alt="">
    </div>
    <div class="thuc_don">
            ...
            foreach($kqdm as $key => $value){
                ?>
                    <div class="thuc_don_pizza" style="margin-left: 40px;">
                        <a href="dmsp.php?id_dm=<?php echo $value['id_dm'] ?>">
                            <img src="picture/<?php echo $value['anhdm']?>" alt="">
    ...
    <div class="container">
        <?php
            if(isset($_GET['id_dm'])){
            $id_dm=$_GET['id_dm'];
            $sql="SELECT * FROM danhmucsp AS dm, sanpham as sp WHERE sp.id_dm=dm.id_dm and sp.id_dm='$id_dm'";
            $kq=$con->query($sql);
            foreach($kq as $do =>$sp){
                ?>
 <div class="contai">
            <div class="box">
                <img src="picture/<?php echo $sp['anhdd'] ?>" alt="">
                ...
                <button><a class="muahang" href="chitietsp.php?ma=<?php echo $sp['id_sp'] ?>">Mua hàng</a></button>
            </div>
            <?php
                if($id_dm==1){
                    ?>
                ...
                <div class="tt_chi_tiet">
                    ...
                    <div class="kt_gia">
                        <div class="gia">
                            <img src="picture/icon-P-S.png" alt="">
                            <span>Size S / 20cm / 90.000đ</span>
                        </div>
                        <div class="gia">
                            <img src="picture/icon-P-M.png" alt="">
                            <span>Size M / 24cm / 110.000đ</span>
                        </div>
                        <div class="gia">
                            <img src="picture/icon-P-L.png" alt="">
                ...
                <div class="combo_item-colum">
                    <?php 
                        ...
                        <div class="combo_thumb">
                            <img src="./picture/<?php echo $cb['anhdd'] ?>" alt="">
                        </div>
